...
NEW_PERSONS_DIR = os.path.normpath(os.path.join(PROJECT_ROOT, "data", "NewPersonImages"))

# Folder containing new people
add_new_people(NEW_PERSONS_DIR)
...
# metrics = evaluate(
#     os.path.join(PROJECT_ROOT, "data", "TestImages"),
#     threshold=THRESHOLD
# )
